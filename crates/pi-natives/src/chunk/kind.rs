...
impl ChunkKind {
	pub const fn prefix(self) -> &'static str {
		match self {
			...
			Self::Imports => "imp",
			Self::Includes => "incl",
			Self::InlineFragment => "infrag",
			Self::Install => "inst",
			Self::Interface => "intf",
			Self::Interpolation => "intrp",
			Self::Item => "item",
			Self::Join => "join",
			Self::Key => "key",
			Self::KeyScripts => "keyscr",
			Self::Label => "label",
			Self::Let => "let",
			Self::List => "list",
			Self::Loop => "loop",
			...
			Self::Schema => "schema",
			Self::Script => "script",
			Self::ScriptModule => "scrmod",
			Self::ScriptSetup => "scrset",
			Self::Section => "sect",
			Self::Select => "select",
			Self::Setting => "setng",
			Self::Shebang => "shbng",
			...
			Self::Source => "source",
			Self::Stage => "stage",
			Self::StaticInit => "sinit",
			Self::Statements => "stmts",
			Self::Struct => "struct",
			Self::Style => "style",
			Self::StyleScoped => "scoped",
			Self::Switch => "switch",
			Self::Table => "table",
			Self::Tag => "tag",
			Self::Target => "target",
